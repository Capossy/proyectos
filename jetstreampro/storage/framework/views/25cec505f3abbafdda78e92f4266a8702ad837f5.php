...
<?php $component->withAttributes([]); ?>
    <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
        <a href="<?php echo e(route ('register')); ?>" class="ml-4 text-sm text-gray-700 underline">Registrarte</a>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\proyectos\jetstreampro\resources\views/auth/login.blade.php ENDPATH**/ ?>